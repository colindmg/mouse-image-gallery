...
//   const uDeltaX = useSpring(0, { stiffness: 100, damping: 20 });
//   const uDeltaY = useSpring(0, { stiffness: 100, damping: 20 });
...
//     uniforms.current.uDelta.value = { x: uDeltaX.get(), y: uDeltaY.get() };
//   });
